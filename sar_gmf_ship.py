...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 09:59:26 2017
...
with h5py.File(hdf,"r") as f:
    ...
    for i in range(nb_shuffle):
        ...
        # Weights
        print "weights"
        w=f["weights/"+fl][l] # np.array, shape = (1898, 99856)
        # Train nrcs
        print "nrcs"
        ...
        # Input ship
        print "mask"
        input_ship = f["masks/train/"+fl][l][...,1] #[...,1]: ship
        print "weights"
        w[w==1.]=weight_boats
        w[w==0.]=weight_sea   
...
with h5py.File(hdf,"r") as f:
    ...
    input_ship = f["masks/training_images/"+fl][:][...,1]#.reshape(-1,size_out,size_out,2)
