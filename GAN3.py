...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 13:55:31 2017
...
height = 508
nbClass = 2 # Nombre de classes à distinguer
...
with h5py.File(hdf_data,"r") as f:
    ...
    for i in range(nb_shuffle):
        ...
        train_mask=f["masks/train/"+fl0][l][:,o:-o,o:-o,[0,2]].reshape((-1,size_out*size_out,nbClass))
