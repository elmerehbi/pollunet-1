...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 28 09:49:19 2017
...
# reduce the size
x = Conv2D(8,1,padding='valid',data_format='channels_first')(x) # <tf.Tensor 'conv2d_10/add:0' shape=(?, 8, 324, 324) dtype=float32>
c = crop() # reset crop
y = unet_layers(ship,depth,channels_max) # <tf.Tensor shape=(?, 24, 324, 324) dtype=float32>
# reduce the size
y = Conv2D(8,1,padding='valid',data_format='channels_first')(y)
x = keras.layers.multiply([x, y]) # <tf.Tensor 'add_1/add:0' shape=(?, 24, 324, 324) dtype=float32>
