...
def UNETGenerator(input_img_dim, num_output_channels):
    ...
    # 5 encoder C512
    en_5 = Conv2D(filters=512, kernel_size=(4,4), padding='same', strides=(stride, stride))(en_4)
    ...
    de_3 = Dropout(rate=0.5)(de_3) # shape=(?, 1024, 16, 16)
    de_3 = concatenate([de_3, en_5], axis=1)
    de_3 = Activation('relu')(de_3)

    # 4 decoder CD1024 (decodes en_5)
    de_4 = UpSampling2D(size=(2, 2))(de_3)
    de_4 = Conv2D(filters=1024, kernel_size=(4,4), padding='same')(de_4)
    ...
    de_5 = Activation('relu')(de_5) # shape=(?, 1280, 64, 64)
    ...
    de_6 = concatenate([de_6, en_2], axis=1) # de_6
